...
public class MainMenuController {
    ...
    @FXML private LineChart<String, Number>     lineChart;   // ← LineChart remplace BarChart
    ...
    private void chargerLineChart() {
        try {
            ...
            // ✅ Colorier les courbes et points après rendu
            // Série 0 (Total RDV)  → rose vif   #ad1457
            // Série 1 (En attente) → mauve rosé  #c9a0c8
