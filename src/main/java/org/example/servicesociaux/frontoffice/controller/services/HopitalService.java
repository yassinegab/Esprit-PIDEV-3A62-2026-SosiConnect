    ...
    public List<Object[]> afficherAvecRendezVous() throws SQLException {
        ...
        while (rs.next()) {
            liste.add(new Object[]{
                    rs.getInt("id"),                           // [0]
                    rs.getString("nom"),                       // [1]
                    rs.getString("adresse"),                   // [2]
                    rs.getString("tel"),                       // [3]
                    rs.getString("specialites"),               // [4]
                    rs.getString("ville"),                     // [5]
                    rs.getInt("nb_rdv"),                       // [6]
                    rs.getInt("rdv_en_attente"),               // [7]
                    rs.getInt("capacite"),                     // [8]
                    rs.getBoolean("service_urgence_dispo")     // [9]
            });
        }
        return liste;
    }
